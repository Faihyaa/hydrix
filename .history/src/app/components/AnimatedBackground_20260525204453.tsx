export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="animation-delay-1 absolute -bottom-8 left-1/2 h-72 w-72 animate-blob-fast rounded-full bg-sky-200 opacity-30 mix-blend-multiply blur-xl filter"></div>
    </div>
  );
}