...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-up">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed text-left">
              Advanced IoT-powered flood monitoring designed to help communities stay prepared before disasters happen.
            </p>
      ...
      <section className="w-full px-4 py-16 bg-gradient-to-br from-blue-50 to-cyan-50">
