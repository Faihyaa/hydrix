        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              <div className="absolute top-20 left-20 text-6xl text-white/80 animate-[float_6s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-16 right-20 text-5xl text-white/60 animate-[float_7s_ease-in-out_infinite]">
                ?
              </div>
