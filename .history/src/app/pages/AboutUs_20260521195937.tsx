        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              <div className="absolute top-10 left-10 text-4xl text-white/30 animate-[float_6s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-20 right-14 text-2xl text-white/25 animate-[float_7s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-16 left-16 text-3xl text-white/20 animate-[float_5.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-10 right-10 text-5xl text-white/30 animate-[float_6.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-1/2 left-0 text-xl text-white/20 animate-[float_8s_ease-in-out_infinite]">
                ?
              </div>
