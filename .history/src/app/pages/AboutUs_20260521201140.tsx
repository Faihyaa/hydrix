        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              <div className="text-[200px] md:text-[220px] font-bold text-white select-none">
                ?
              </div>

              {/* Floating question marks (ENLARGED) */}
              <div className="absolute top-2 left-30 text-6xl text-white/80 animate-[float_6s_ease-in-out_infinite]">
                ?
              </div>
