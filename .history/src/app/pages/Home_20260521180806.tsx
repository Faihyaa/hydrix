...
<section className="container mx-auto px-4 py-16 max-w-7xl overflow-hidden">
  <div className="grid lg:grid-cols-2 gap-12 items-center">
    ...
    <div className="relative flex justify-center items-center min-h-[420px]">
      ...
      {/* Bubble 1 */}
      <div className="absolute top-0 left-10 w-44 h-44 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 text-white shadow-2xl flex flex-col items-center justify-center animate-bounce hover:scale-110 transition-transform duration-300">
      ...
      {/* Bubble 2 */}
      <div className="absolute top-32 right-0 w-52 h-52 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 text-white shadow-2xl flex flex-col items-center justify-center animate-pulse hover:scale-110 transition-transform duration-300">
        <div
      ...
      {/* Bubble 3 */}
      <div className="absolute bottom-0 left-24 w-40 h-40 rounded-full bg-gradient-to-br from-blue-400 to-cyan-500 text-white shadow-2xl flex flex-col items-center justify-center animate-bounce hover:scale-110 transition-transform duration-300">
