      ...
      <section className="container mx-auto px-4 py-16 animate-fade-in max-w-7xl">
        <div className="text-center max-w-4xl mx-auto animate-slide-up">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/dashboard">
              <Button size="lg" className="w-48 bg-gradient-to-r from-blue-600 to-cyan-500 hover:bg-gradient-to-r hover:from-blue-700 hover:to-cyan-600 text-lg px-8">
                View Dashboard
              </Button>
            </Link>
            <Link to="/about">
              <Button size="lg" variant="outline" className="w-48 text-lg px-8 border-blue-300 text-blue-700 hover:bg-blue-50">
                Learn More
              </Button>
            </Link>
          </div>
