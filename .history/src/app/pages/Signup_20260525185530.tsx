...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ This automatically saves to Firestore via AuthContext
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center p-6 gap-8">
      ...
      <div className="relative z-10 flex flex-col items-center gap-2 animate-fade-in text-center">
        ...
        <h1 className="text-3xl font-bold text-blue-900 mt-1">Join HydriX</h1>
        <p className="text-gray-500 text-sm">Create your account and start monitoring today!</p>
      </div>
