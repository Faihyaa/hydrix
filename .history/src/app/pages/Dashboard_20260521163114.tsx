      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1fr", gap: "16px", marginBottom: "16px" }}>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
            <span>💧</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Water Level</p>
          </div>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
            <span>🌡️</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Temperature</p>
          </div>
          <p style={{ fontSize: "40px", fontWeight: "700", color: "#f97316", margin: "0 0 8px" }}>
            {getValue("temperature")} <span style={{ fontSize: "18px" }}>°C</span>
          </p>
          <p style={{ fontSize: "12px", color: "var(--muted-foreground)", margin: 0 }}>Last update · {lastUpdated}</p>
        </div>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
            <span>💦</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Humidity</p>
          </div>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
            <span>🌬️</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Pressure</p>
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "16px", marginBottom: "16px" }}>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
            <span>☔</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Sensor Readings — Realtime</p>
          </div>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
            <span>🌧️</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Rain Status</p>
          </div>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
            <span>📊</span>
            <p style={{ fontSize: "13px", color: "var(--muted-foreground)", margin: 0 }}>Rainfall Percent</p>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                ...
                style={{ background: "none", border: "none", fontSize: "20px", cursor: "pointer", color: "var(--muted-foreground)" }}
              >
                ✕
              </button>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <label style={{ fontSize: "12px", color: "var(--muted-foreground)" }}>From:</label>
                <input
                  type="date"
                  value={startDate}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <label style={{ fontSize: "12px", color: "var(--muted-foreground)" }}>To:</label>
                <input
                  type="date"
                  value={endDate}
            ...
            <div style={{ overflowY: "auto", flex: 1 }}>
              {historyLoading ? (
                <p style={{ textAlign: "center", color: "var(--muted-foreground)", padding: "40px" }}>Loading history...</p>
              ) : history.length === 0 ? (
                <p style={{ textAlign: "center", color: "var(--muted-foreground)", padding: "40px" }}>No records found.</p>
              ) : (
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "13px" }}>
                  <thead style={{ position: "sticky", top: 0 }}>
                    <tr style={{ background: "var(--card)", borderBottom: "1px solid var(--border)" }}>
                      {["Date & Time", "Water (cm)", "Temp (°C)", "Humidity (%)", "Pressure (hPa)", "Rain (%)", "Rain Status"].map(h => (
                        <th key={h} style={{ padding: "10px 12px", textAlign: "left", color: "var(--muted-foreground)", fontWeight: "600", whiteSpace: "nowrap" }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
                    {history.map((record, i) => (
                      <tr key={record.id} style={{ borderBottom: "1px solid var(--border)", background: i % 2 === 0 ? "var(--card)" : "var(--background)" }}>
                        ...
                        <td style={{ padding: "10px 12px", color: "var(--muted-foreground)" }}>{record.rainPercent ?? "-"}</td>
