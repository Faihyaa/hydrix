  ...
  return (
    <>
      ...
      <div className="relative flex justify-center items-center min-h-[300px]">
        ...
        <div className="absolute -top-2 -left-2 text-7xl text-blue-500/60 animate-[float_6s_ease-in-out_infinite]">
          ?
        </div>

        <div className="absolute -top-1 -right-2 text-5xl text-cyan-500/50 animate-[float_7s_ease-in-out_infinite]">
          ?
        </div>
