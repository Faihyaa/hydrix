        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            {[
              ...
              {
                icon: Database,
                title: "Store, Process & Sync Data",
                description:
                  "ThingsBoard process the sensor data and sends to Firebase through Render for real-time storage while also allowing direct updates to the website for faster live monitoring.",
              ...
              },
              {
                ...
                description:
                  "The website displays live dashboards and triggers flood alert notifications when risk levels become critical.",
                color: "from-blue-500 to-cyan-500",
              },
            ].map((step, index) => {
