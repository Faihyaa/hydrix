        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              <div className="absolute -top-6 -right-30 text-7xl text-white/80 animate-[float_6s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute -top-4 -right-20 text-6xl text-white/70 animate-[float_7s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute -bottom-6 -left-30 text-7xl text-white/60 animate-[float_5.5s_ease-in-out_infinite]">
                ?
              </div>
