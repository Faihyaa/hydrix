      ...
      <div className="relative flex justify-center items-center min-h-[460px]">
        ...
        <div className="relative w-[380px] h-[460px]">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-8 left-10 w-10 h-10 bg-blue-200/70 rounded-full shadow-md animate-[float_6s_ease-in-out_infinite]"></div>

            <div className="absolute top-12 right-8 w-12 h-12 bg-cyan-200/70 rounded-full shadow-md animate-[float_7s_ease-in-out_infinite]"></div>

            <div className="absolute top-1/2 left-0 w-9 h-9 bg-blue-300/60 rounded-full shadow-md animate-[float_5.5s_ease-in-out_infinite]"></div>

            <div className="absolute top-1/2 right-0 w-10 h-10 bg-cyan-300/60 rounded-full shadow-md animate-[float_6.5s_ease-in-out_infinite]"></div>

            <div className="absolute bottom-12 left-14 w-11 h-11 bg-blue-200/70 rounded-full shadow-md animate-[float_6.8s_ease-in-out_infinite]"></div>

            <div className="absolute bottom-10 right-16 w-10 h-10 bg-cyan-200/70 rounded-full shadow-md animate-[float_7.2s_ease-in-out_infinite]"></div>

          </div>

          {/* Bubble 1 - Monitoring (BLUE) */}
          <div className="absolute top-0 left-4 w-44 h-44 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 text-white shadow-2xl flex flex-col items-center justify-center hover:scale-110 hover:-translate-y-2 transition-all duration-300 animate-[float_6s_ease-in-out_infinite]">
          ...
          {/* Bubble 2 - ALERT (RED emphasis) */}
          <div className="absolute top-32 right-0 w-52 h-52 rounded-full bg-gradient-to-br from-red-500 to-orange-400 text-white shadow-2xl flex flex-col items-center justify-center hover:scale-110 hover:-translate-y-2 transition-all duration-300 animate-[float_8s_ease-in-out_infinite]">
            <div
          ...
          {/* Bubble 3 - CLOUD (CYAN/TEAL) */}
          <div className="absolute bottom-0 left-24 w-40 h-40 rounded-full bg-gradient-to-br from-cyan-600 to-teal-400 text-white shadow-2xl flex flex-col items-center justify-center hover:scale-110 hover:-translate-y-2 transition-all duration-300 animate-[float_7s_ease-in-out_infinite]">
