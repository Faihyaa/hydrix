      ...
      <section className="container mx-auto px-4 py-16 max-w-7xl overflow-hidden">
        <div className="container mx-auto px-4 py-15 items-center animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-left"> text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500
              <h1 className="text-4xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 font-bold mb-6">
                What is HydriX ?
              </h1>
