  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              <div className="text-[300px] md:text-[220px] font-bold text-white select-none">
                ?
              </div>

              {/* Floating question marks (ENLARGED) */}
              <div className="absolute top-2 left-30 text-7xl text-white/80 animate-[float_6s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-16 right-30 text-5xl text-white/60 animate-[float_7s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-14 left-14 text-6xl text-white/40 animate-[float_5.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-10 right-10 text-7xl text-white/70 animate-[float_6.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-1/2 left-0 text-4xl text-white/50 animate-[float_8s_ease-in-out_infinite]">
                ?
              </div>
      ...
      <div className="relative flex justify-center items-center min-h-[300px]">
        ...
        {/* Glow background (visible on white bg) */}
        <div className="absolute w-72 h-72 bg-blue-200/40 rounded-full blur-3xl animate-pulse" />

        {/* Big main question mark */}
        <div className="text-[200px] md:text-[220px] font-bold text-blue-900/20 select-none">
          ?
        </div>

        {/* Floating question marks (CLEAN LIGHT MODE VERSION) */}

        <div className="absolute top-2 left-30 text-7xl text-blue-500/60 animate-[float_6s_ease-in-out_infinite]">
          ?
        </div>

        <div className="absolute top-16 right-30 text-5xl text-cyan-500/50 animate-[float_7s_ease-in-out_infinite]">
          ?
        </div>

        <div className="absolute bottom-14 left-14 text-6xl text-blue-400/40 animate-[float_5.5s_ease-in-out_infinite]">
          ?
        </div>

        <div className="absolute bottom-10 right-10 text-7xl text-cyan-500/60 animate-[float_6.5s_ease-in-out_infinite]">
          ?
        </div>

        <div className="absolute top-1/2 -left-4 -translate-y-1/2 text-5xl text-blue-500/40 animate-[float_8s_ease-in-out_infinite]">
          ?
        </div>
