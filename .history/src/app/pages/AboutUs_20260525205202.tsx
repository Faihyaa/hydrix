        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            {[
              ...
              {
                icon: Cpu,
                title: "Process Data via ESP32",
                description:
                  "The collected sensor data is processed by the ESP32 microcontroller for edge computing and wireless transmission.",
                color: "from-cyan-500 to-blue-500",
              },
              {
                icon: Cloud,
                title: "Send Data to Cloud Platform",
                description:
                  "The ESP32 sends sensor data to ThingsBoard through Microsoft Azure for secure real-time cloud processing.",
                color: "from-blue-600 to-cyan-500",
              },
              {
                icon: Database,
                title: "Store & Sync Data",
                description:
                  "All processed data is stored in Firebase to enable real-time syncing and historical tracking.",
                color: "from-cyan-500 to-blue-600",
              },
              {
                icon: Bell,
                title: "Alerts & Visualization",
                description:
                  "The system displays live dashboards and triggers flood alerts when risk levels become critical.",
                color: "from-blue-500 to-cyan-500",
              },
            ].map((step, index) => {
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: "Affordable IoT-based system using scalable architecture",
                  icon: Gauge,
                },
                {
                  title: "Secure Infrastructure",
                  desc: "Data is protected using cloud security and encrypted transmission",
                  icon: ShieldCheck,
                },
              ].map((item, index) => (
                <div
                ...
                >
                  <div className="flex gap-5 items-start">
                    <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-white border border-blue-200 text-blue-600 group-hover:scale-110 transition-transform">
  <item.icon size={24} />
</div>
