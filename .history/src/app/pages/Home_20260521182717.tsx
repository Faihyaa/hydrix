      ...
      <section className="container mx-auto px-4 py-16 max-w-7xl overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center items-center min-h-[420px]">
            ...
            {/* CLUSTER WRAPPER (IMPORTANT FIX) */}
            <div className="relative w-[360px] h-[420px]">

              {/* Decorative Bubbles (now tightly grouped) */}
              <div className="absolute inset-0 pointer-events-none">

                <div className="absolute top-10 left-12 w-10 h-10 bg-cyan-200/70 rounded-full shadow-md animate-[float_6s_ease-in-out_infinite]"></div>

                <div className="absolute top-6 right-10 w-12 h-12 bg-blue-200/70 rounded-full shadow-md animate-[float_7s_ease-in-out_infinite]"></div>

                <div className="absolute top-1/2 left-2 w-9 h-9 bg-cyan-300/60 rounded-full shadow-md animate-[float_5.5s_ease-in-out_infinite]"></div>

                <div className="absolute top-1/2 right-2 w-10 h-10 bg-blue-300/60 rounded-full shadow-md animate-[float_6.5s_ease-in-out_infinite]"></div>

                <div className="absolute bottom-10 left-14 w-11 h-11 bg-cyan-200/70 rounded-full shadow-md animate-[float_6.8s_ease-in-out_infinite]"></div>

                <div className="absolute bottom-12 right-14 w-10 h-10 bg-blue-200/70 rounded-full shadow-md animate-[float_7.2s_ease-in-out_infinite]"></div>

              </div>

              {/* Bubble 1 */}
              <div className="absolute top-0 left-6 w-44 h-44 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 text-white shadow-2xl flex flex-col items-center justify-center hover:scale-110 hover:-translate-y-2 transition-all duration-300 animate-[float_6s_ease-in-out_infinite]">
              ...
              {/* Bubble 2 */}
              <div className="absolute top-28 right-0 w-52 h-52 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 text-white shadow-2xl flex flex-col items-center justify-center hover:scale-110 hover:-translate-y-2 transition-all duration-300 animate-[float_8s_ease-in-out_infinite]">
                <div
              ...
              {/* Bubble 3 */}
              <div className="absolute bottom-0 left-20 w-40 h-40 rounded-full bg-gradient-to-br from-blue-400 to-cyan-500 text-white shadow-2xl flex flex-col items-center justify-center hover:scale-110 hover:-translate-y-2 transition-all duration-300 animate-[float_7s_ease-in-out_infinite]">
