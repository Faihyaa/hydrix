    ...
    <div className="container mx-auto px-4 py-8 animate-fade-in">
      ...
      {activeTab === 'Admin' && (
        <>
          ...
          {editingAdmin && (
            <div className="fixed inset-x-4 top-20 z-50 mx-auto w-full max-w-2xl rounded-2xl border border-purple-200 bg-white shadow-2xl ring-1 ring-black/5">
              <Card className="border-transparent shadow-none">
                ...
                <CardContent className="space-y-4 px-6 py-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="floating-admin-name">Name</Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="floating-admin-email">Email</Label>
                      <Input
                  ...
                  <div className="flex flex-wrap gap-3 justify-end">
                    ...
                    <Button
                      onClick={() => handleSendResetPasswordEmail(editingAdmin.email)}
                      variant="outline"
