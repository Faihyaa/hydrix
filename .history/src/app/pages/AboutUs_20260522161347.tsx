          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                HydriX is a smart flood detection and monitoring system that uses environmental sensors, cloud technology, 
                and real-time data analysis to detect potential flood risks.
              </p>
