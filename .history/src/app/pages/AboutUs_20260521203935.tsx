  ...
  return (
    <>
      ...
      <section className="min-h-screen relative">
        <div className="container mx-auto px-4 min-h-screen flex items-center animate-slide-up">

          <div className="grid md:grid-cols-2 gap-10 items-center">

            {/* LEFT SECTION - Floating Question Marks */}
            <div className="relative flex justify-center items-center min-h-[30px]">
