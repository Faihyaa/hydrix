...
export default function About() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative bgoverflow-hidden">
        <div className="container mx-auto px-4 py-20 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              <h1 className="text-5xl md:text-6xl text-gray-900 font-bold mb-6 leading-tight">
              ...
              <div className="flex gap-4">
                <Link to="/features">
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 rounded-lg font-semibold transition-all">
                    Learn More
                  </Button>
                </Link>
              </div>
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-cyan-500 py-20">
        {/* Background decorations */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-32 left-0 w-80 h-80 bg-white/5 rounded-full blur-3xl" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-10">
              Deploy HydriX today and get early flood warnings that can save lives and property
            </p>
