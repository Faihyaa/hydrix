            ...
            <Dialog open={Boolean(editingUser)} onOpenChange={(open) => { if (!open) setEditingUser(null); }}>
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Update user information and optionally send a password reset email.</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="dialog-user-name">Name</Label>
                    <Input
                      id="dialog-user-name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="dialog-user-email">Email</Label>
                    <Input
                ...
                <DialogFooter className="mt-4 gap-2">
                  ...
                  <Button
                    onClick={() => handleSendResetPasswordEmail(editingUser.email)}
                    variant="outline"
            ...
            <Dialog open={Boolean(editingAdmin)} onOpenChange={(open) => { if (!open) setEditingAdmin(null); }}>
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Update admin information and optionally send a password reset email.</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="dialog-admin-name">Name</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="dialog-admin-email">Email</Label>
                    <Input
                ...
                <DialogFooter className="mt-4 gap-2">
                  <Button onClick={handleUpdateAdmin} className="bg-purple-600 hover:bg-purple-700">
                    Update Admin
                  </Button>
                  <Button
