...
<div className="relative flex justify-center items-center min-h-[300px]">
  ...
  {/* TIGHT ORBIT MINI QUESTION MARKS */}

  <div className="absolute -top-2 -left-2 text-6xl text-white/80 animate-[float_6s_ease-in-out_infinite]">
    ?
  </div>

  <div className="absolute -top-1 -right-2 text-5xl text-white/70 animate-[float_7s_ease-in-out_infinite]">
    ?
  </div>

  <div className="absolute -bottom-2 -left-2 text-6xl text-white/60 animate-[float_5.5s_ease-in-out_infinite]">
    ?
  </div>

  <div className="absolute -bottom-1 -right-2 text-7xl text-white/80 animate-[float_6.5s_ease-in-out_infinite]">
    ?
  </div>

  <div className="absolute top-1/2 -left-4 -translate-y-1/2 text-5xl text-white/50 animate-[float_8s_ease-in-out_infinite]">
    ?
  </div>
