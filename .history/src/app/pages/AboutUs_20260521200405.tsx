        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              <div className="absolute bottom-14 left-14 text-6xl text-white/70 animate-[float_5.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-10 right-10 text-7xl text-white/40 animate-[float_6.5s_ease-in-out_infinite]">
                ?
              </div>
