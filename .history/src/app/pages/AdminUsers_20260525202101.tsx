    ...
    <div className="container mx-auto px-4 py-8 animate-fade-in">
      ...
      {activeTab === 'User' && (
        <>
          ...
          {editingUser && (
            <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 backdrop-blur-sm px-4 py-10">
              <div className="w-full max-w-2xl animate-in fade-in zoom-in-95 duration-200">
                <Card className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
                  ...
                  {/* Header */}
                  <CardHeader className="border-b border-slate-100 bg-gradient-to-r from-blue-50 to-slate-50 px-6 py-5">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                          Update user information and manage account actions.
                        </p>
                      </div>
                  ...
                  <CardContent className="space-y-6 px-6 py-6">
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="h-11 rounded-xl border-slate-300 focus-visible:ring-2 focus-visible:ring-blue-500"
                        />
                      </div>

                      <div className="space-y-2">
                        <Label
                          htmlFor="floating-user-email"
                          className="text-sm font-medium text-slate-700"
                        >
                          Email
                        </Label>
                        ...
                        <Input
                          ...
                          disabled
                          className="h-11 rounded-xl bg-slate-100 text-slate-500"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
                      ...
                      <Button
                        variant="outline"
                        onClick={() =>
                          handleSendResetPasswordEmail(editingUser.email)
                        }
                      ...
                      <Button
                        ...
                        className="rounded-xl bg-blue-600 px-6 font-medium text-white shadow-lg transition-all hover:bg-blue-700 hover:shadow-blue-200"
                      >
                        Update User
                      </Button>
                    </div>
            ...
            <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 backdrop-blur-sm px-4 py-10">
              <div className="w-full max-w-2xl animate-in fade-in zoom-in-95 duration-200">
                <Card className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
                  ...
                  {/* Header */}
                  <CardHeader className="border-b border-slate-100 bg-gradient-to-r from-purple-50 to-slate-50 px-6 py-5">
                    <div className="flex items-center justify-between">
                      <div>
                        <CardTitle className="text-2xl font-bold text-slate-800">
                          Edit Admin
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                          Manage admin details and account settings.
                        </p>
                      </div>
                  ...
                  <CardContent className="space-y-6 px-6 py-6">
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="h-11 rounded-xl border-slate-300 focus-visible:ring-2 focus-visible:ring-purple-500"
                        />
                      </div>

                      <div className="space-y-2">
                        <Label
                          htmlFor="floating-admin-email"
                          className="text-sm font-medium text-slate-700"
                        >
                          Email
                        </Label>
                    ...
                    <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
                      ...
                      <Button
                        variant="outline"
                        onClick={() =>
                          handleSendResetPasswordEmail(editingAdmin.email)
                        }
                      ...
                      <Button
                        ...
                        className="rounded-xl bg-purple-600 px-6 font-medium text-white shadow-lg transition-all hover:bg-purple-700 hover:shadow-purple-200"
                      >
                        Update Admin
                      </Button>
                    </div>
