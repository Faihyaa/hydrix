        ...
        <div className="container mx-auto px-4 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex justify-center items-center min-h-[300px]">
              ...
              {/* Glow background */}
              <div className="absolute w-72 h-72 bg-white/10 rounded-full blur-l animate-pulse" />

              {/* Big main question mark */}
              <div className="text-[180px] md:text-[220px] font-bold text-white/20 select-none">
                ?
              </div>

              {/* Floating question marks (ENLARGED) */}
              <div className="absolute top-8 left-10 text-6xl text-white/30 animate-[float_6s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-16 right-14 text-5xl text-white/25 animate-[float_7s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-14 left-14 text-6xl text-white/20 animate-[float_5.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute bottom-10 right-10 text-7xl text-white/30 animate-[float_6.5s_ease-in-out_infinite]">
                ?
              </div>

              <div className="absolute top-1/2 left-0 text-4xl text-white/20 animate-[float_8s_ease-in-out_infinite]">
                ?
              </div>
