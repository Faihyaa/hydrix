...
export default function AdminUsers() {
  ...
  const isCoreAdmin = user?.email === 'admin@floodet.com';
  ...
  const loadUsers = () => {
    const storedUsers = JSON.parse(localStorage.getItem('floodet_users') || '[]');
  ...
  const handleAddUser = () => {
    ...
    localStorage.setItem('floodet_users', JSON.stringify(storedUsers));
  ...
  const handleDeleteAdmin = (adminToDelete: UserData) => {
    if (adminToDelete.email === 'admin@floodet.com') {
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                <p className="font-semibold text-gray-800">{userData.name}</p>
                                {userData.email === 'admin@floodet.com' && (
              ...
              <Card className="mt-6 bg-amber-50 border-amber-200">
                <CardContent className="p-4">
                  <p className="text-sm text-amber-800">
                    <strong>Note:</strong> Only the core admin (admin@floodet.com) can add, edit, or remove other administrators.
                  </p>
                </CardContent>
              </Card>
            )}
