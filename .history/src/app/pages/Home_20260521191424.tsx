          ...
          <div className="relative flex justify-center items-center min-h-[460px]">
            ...
            <div className="relative w-[380px] h-[460px]">
              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-8 left-10 w-10 h-10 bg-green-200/70 rounded-full shadow-md animate-[float_6s_ease-in-out_infinite]" />
                <div className="absolute top-12 right-8 w-12 h-12 bg-green-300/60 rounded-full shadow-md animate-[float_7s_ease-in-out_infinite]" />
                <div className="absolute top-1/2 left-0 w-9 h-9 bg-emerald-200/70 rounded-full shadow-md animate-[float_5.5s_ease-in-out_infinite]" />
                <div className="absolute top-1/2 right-0 w-10 h-10 bg-green-300/60 rounded-full shadow-md animate-[float_6.5s_ease-in-out_infinite]" />
                <div className="absolute bottom-12 left-14 w-11 h-11 bg-emerald-200/70 rounded-full shadow-md animate-[float_6.8s_ease-in-out_infinite]" />
                <div className="absolute bottom-10 right-16 w-10 h-10 bg-green-200/70 rounded-full shadow-md animate-[float_7.2s_ease-in-out_infinite]" />

              </div>

              {/* Bubble 1 - Real Time Monitoring (GREEN) */}
              <div className="absolute top-0 left-4 w-44 h-44 rounded-full bg-gradient-to-br from-green-600 to-emerald-400 text-white shadow-2xl flex flex-col items-center justify-center animate-[float_6s_ease-in-out_infinite]">
              ...
              {/* Bubble 2 - Instant Alert (YELLOW) */}
              <div className="absolute top-32 right-0 w-52 h-52 rounded-full bg-gradient-to-br from-yellow-400 to-amber-300 text-white shadow-2xl flex flex-col items-center justify-center animate-[float_8s_ease-in-out_infinite]">
                <div
              ...
              {/* Bubble 3 - Cloud Connected (BLUE) */}
              <div className="absolute bottom-0 left-24 w-40 h-40 rounded-full bg-gradient-to-br from-blue-600 to-cyan-400 text-white shadow-2xl flex flex-col items-center justify-center animate-[float_7s_ease-in-out_infinite]">
